...
class node
{
    ...
    private $_compatible = array('ArWordTag'=>'WordTag',
        'ArWordTag'=>'isim_fungsi',
        'ArWordTag'=>'fiil_fungsi',
        'ArWordTag'=>'kalimah',
        'ArWordTag'=>'isim_irob',
        'ArWordTag'=>'fiil_irob',
        'ArWordTag'=>'tanda_irob',
        'ArWordTag'=>'isim',
        'ArWordTag'=>'fiil',
        'ArWordTag'=>'kedudukan',
        'ArWordTag'=>'huruf');
    ...
    {
        $dir  = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Main';
