...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon" href="img/nahwu.jpeg">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-1" src="img/nahwu.jpeg" alt="">
        </span><br><br><br>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="help.html">Al - Imrithi</a>
          </li>
        </ul>
      </div>
    </nav>
...
<script>
  ...
  <script type="text/javascript" src="vk_loader.js?vk_layout=SA%20Arabic%20(101)&vk_skin=flat_gray" ></script>
    <!-- Le styles -->
...
$(document).ready(function(){
    ...
    <link href="css/resume.min.css" rel="stylesheet">
    <!-- <link href="ikicss/bootstrap.css" rel="stylesheet"> -->
    <style type="text/css">
    textarea {
        font-size: 20pt;
        font-family: Arial;
  ...
  <center>
    <div class="container-narrow">
      <div class="masthead">
          <h1 class="mb-0">I'rob bi
            <span class="text-primary">Imrithi</span>
          </h1>
      </div><br><br>
...
<br>
  ...
  <div class="tab-content">
    ...
    <table class="table table-hover table-bordered"> 
        ...
        echo"<tr><th>Kalam</th><th>Nadom</th></tr>";
        echo"<td><h4>";
        echo"<h3>";
        foreach ($words as $word) {
        $nodenya = ($json_idr['kategori'][$word]['node']); 
